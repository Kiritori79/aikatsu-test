...
const QUESTIONS = [
  {
    ...
    options: [
      { label: "立刻约人出去玩", scores: { ichigo: 2, kii: 1 } },
      { label: "待在家慢慢整理最近的事情", scores: { aoi: 2, sakura: 1 } },
      { label: "去完成已经计划好的目标", scores: { ran: 2, mizuki: 1 } },
      { label: "找一家氛围很好的店发呆", scores: { sora: 2, otome: 1 } },
      { label: "半夜突然出门散步", scores: { yurika: 2, kaede: 1 } },
    ],
  },
  {
    id: "q2",
    text: "你更容易被什么吸引？",
    options: [
      { label: "有感染力的人", scores: { ichigo: 2, maria: 1 } },
      { label: "聪明又观察细致的人", scores: { aoi: 2, sakura: 1 } },
      { label: "气场很强的人", scores: { ran: 2, seira: 1 } },
      { label: "像童话一样的东西", scores: { otome: 2, sora: 1 } },
      { label: "神秘又有距离感的人", scores: { yurika: 2, mizuki: 1 } },
    ],
  },
  {
    id: "q3",
    text: "深夜睡不着时，你通常会：",
    options: [
      { label: "开始幻想未来很多可能", scores: { ichigo: 2, kaede: 1 } },
      { label: "思考现实里的问题", scores: { aoi: 2, mizuki: 1 } },
      { label: "想「自己还不够强」", scores: { ran: 2, seira: 1 } },
      { label: "脑内自动开始小剧场", scores: { otome: 2, yurika: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "认真努力后的成果", scores: { aoi: 2, ran: 1 } },
      { label: "绝对不会输的压迫感", scores: { mizuki: 2, seira: 1 } },
      { label: "像梦境一样的氛围", scores: { sora: 2, otome: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "认真听对方讲话", scores: { aoi: 2, maria: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "刚下完雨的安静天气", scores: { aoi: 2, sakura: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "自己进步很明显", scores: { ran: 2, mizuki: 1 } },
      { label: "看到漂亮又可爱的东西", scores: { otome: 2, sora: 1 } },
      { label: "被说「你很特别」", scores: { yurika: 2, kaede: 1 } },
    ],
  },
  {
    id: "q8",
    ...
    options: [
      ...
      { label: "提前做很多准备", scores: { aoi: 2, mizuki: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "整洁舒服、方便生活", scores: { aoi: 2, sakura: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "让别人永远记住自己", scores: { yurika: 2, mizuki: 1 } },
    ],
  },
  {
    id: "q11",
    text: "如果你是电影角色，你更像：",
    options: [
      { label: "成长型主角", scores: { ichigo: 2, kii: 1 } },
      { label: "军师型角色", scores: { aoi: 2, sakura: 1 } },
      { label: "冷脸强者", scores: { ran: 2, seira: 1 } },
      { label: "梦幻系配角", scores: { otome: 2, sora: 1 } },
      { label: "亦正亦邪的神秘角色", scores: { yurika: 2, kaede: 1 } },
    ],
  },
  {
    id: "q12",
    text: "你最容易因为什么心软？",
    options: [
      { label: "别人很努力的时候", scores: { ichigo: 2, maria: 1 } },
      { label: "别人藏起来的小情绪", scores: { aoi: 2, sakura: 1 } },
      { label: "有人拼命坚持目标", scores: { ran: 2, mizuki: 1 } },
